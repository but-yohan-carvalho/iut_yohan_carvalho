...
#include "CB_RX1.h"
#include "Toolbox.h"
#define CBRX1_BUFER_SIZE 128

int cbRx1Head;
int cbRx1Tail;
unsigned char cbRx1Buffer[CBRX1_BUFER_SIZE];
...
int CB_RX1_GetRemainingSize(void) {
    return CBRX1_BUFER_SIZE-CB_RX1_GetDataSize();
}
...
int CB_RX1_GetDataSize(void) {
    ...
    if (cbRx1Head >= cbRx1Tail) {
        ...
        dataSize = CBRX1_BUFER_SIZE - (cbRx1Tail - cbRx1Head);
    }
    return dataSize;
}
